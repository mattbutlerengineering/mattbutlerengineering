...
export const CHECKS = [
  ...
  { id: "M4.3", dimension: "Measurement", level: 4, description: "Agent spend tracking (.claude/agent-spend.jsonl or equivalent)",
    remedy: "Track agent cost per run (e.g. JSONL with {runId, cost, date}). Enables per-issue ROI + budget alerts." },
