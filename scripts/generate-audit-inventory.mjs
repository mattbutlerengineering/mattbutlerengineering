 ...
 *
 * This is a standalone script that mirrors the SURFACE_REGISTRY
 * in packages/agent-core/src/audit-inventory.ts so it can run
...
const BASE_URL = "https://mattbutlerengineering.com";
const INVENTORY_VERSION = 1;

function surface(id, zone, type, path, sourceFiles, auth = "none") {
  return {
    id,
    zone,
    type,
