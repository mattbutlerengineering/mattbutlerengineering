 ...
 *
 * The push trigger cannot cover this either — its `paths-ignore` lists
 * `docs/**` and `**.md`, so a docs-only merge runs no push CI at all. The PR
 * gate is the only place this can be caught before it lands.
 *
