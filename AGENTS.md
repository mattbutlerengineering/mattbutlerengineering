...
The continuous-improvement loop (audit → fix → ship → verify) runs as **Claude Code slash-skills**, not `mbe` CLI subcommands. See [CLAUDE.md](./CLAUDE.md#continuous-improvement-loop-ship-loop) for the full skill catalog and scheduling.
