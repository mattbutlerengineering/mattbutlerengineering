...
const CRITERIA = [
  ...
  },
  {
    ...
    detection: {
      type: "any-of",
      pattern: ["web/public/analytics.js", "web/src/components/analytics/"],
    },
...

  {
    ...
    detection: {
      type: "any-of",
      pattern: ["scripts/acmm/repo-bench.js", "docs/acmm/repo-benchmark.md"],
    },
  },
  ...
  },
  {
    ...
    detection: {
      type: "any-of",
      pattern: ["web/netlify/functions/analytics-accm.mts", "web/public/analytics.js"],
    },
  },
  {
  ...
  },
  {
    ...
    detection: {
      type: "any-of",
      pattern: [".claude/fallback-policy.json", "docs/acmm/ai-service-fallback.md"],
    },
  },
  {
