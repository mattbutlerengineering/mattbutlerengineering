          ...
          props={[
            {
              ...
              type: "TapeChartReservation[]",
              default: "—",
              description: "Required. End-date is exclusive (checkout day).",
            },
            ...
            { name: "currency", type: "string", default: "USD", description: "ISO 4217 fallback." },
            {
              ...
              default: '"comfortable"',
              description: "Row height and padding scale.",
            },
            {
              name: "viewMode",
              type: '"grid" | "list"',
            ...
            {
              name: "onReservationClick",
              type: "(r) => void",
              default: "—",
              description: "Fired on click or Enter/Space on a bar.",
            },
            {
              name: "onReservationMove",
              type: "(payload) => void | Promise",
              default: "—",
              description: "Opens move dialog (v2).",
            },
            {
              name: "checkConflict",
              type: "(payload) => Promise<bool|string>",
              default: "—",
              description: "Server-side conflict check.",
            },
            {
              name: "selectedReservationId",
              type: "string | null",
              default: "null",
              description: "Highlighted reservation.",
            },
            {
              name: "loading",
              type: "boolean",
              default: "false",
              description: "Shows skeleton or refresh banner.",
            },
            {
              name: "error",
              type: "Error | null",
            ...
            {
              name: "strings",
              type: "TapeChartStrings",
              default: "English defaults",
              description: "All user-visible text + plural callbacks.",
            },
          ]}
        />
      </Section>
