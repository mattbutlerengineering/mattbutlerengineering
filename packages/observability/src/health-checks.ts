/**
 * Shared health check utilities — Auth0 reachability, DB latency anomaly detection.
 *
 * Extracted from per-service health-checks.ts files (identical across users, reservations, agent).
 */
