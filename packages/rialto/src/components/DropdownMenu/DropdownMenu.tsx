...
export const DropdownMenu = forwardRef<HTMLDivElement, DropdownMenuProps>(
  function DropdownMenu({ trigger, items, align = 'left' }, ref) {
    ...
    function handleKeyDown(e: React.KeyboardEvent) {
      ...
      switch (e.key) {
        case 'ArrowDown': {
          e.preventDefault();
          const next =
            currentPos < focusableIndices.length - 1 ? currentPos + 1 : 0;
        ...
        case 'ArrowUp': {
          e.preventDefault();
          const prev =
            currentPos > 0 ? currentPos - 1 : focusableIndices.length - 1;
