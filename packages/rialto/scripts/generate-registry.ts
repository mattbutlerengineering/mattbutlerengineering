 ...
 * Compiler API to extract component metadata and outputs registry.json at
 * the package root.
 *
 * The registry extends the manifest format with `importPath` for each
 * component, enabling AI tools to programmatically discover and consume
...
function extractComponents(program: ts.Program, entryFile: string): RegistryComponent[] {
