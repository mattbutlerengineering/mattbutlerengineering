...
_Generated 2026-04-26 · 45/85 criteria detected · role: **Strategist**_
...
**Since last run:** L6 (unchanged) · 47 → 45 detected (-2).

**Regressed (-2):** `acmm:agents-md`, `aef:cross-tool-config`
