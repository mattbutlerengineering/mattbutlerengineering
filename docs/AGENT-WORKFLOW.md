...
| Step      | What                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Collect   | Run the unified sensor report incl. ACMM, PRs, cost, CI, Lighthouse, issues, sessions, `metricsFreshness`, `reviewBurden`. **Best-effort here** — the loop runs as a Claude Code Remote session with no `gh` CLI, so the review-burden collector skips; `.github/workflows/metrics-collectors.yml` is the scheduled home that actually produces data (#5528), and `metricsFreshness` (#5529) reports it when it stops |
