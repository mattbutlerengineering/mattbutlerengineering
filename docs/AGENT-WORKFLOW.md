...
| Step      | What                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Collect   | Run `scripts/collect-domain-metrics.mjs` (booking-funnel telemetry), then sensors incl. ACMM, PRs, cost, CI, Lighthouse, issues, sessions, `domainActivity`, `metricsFreshness`, `reviewBurden`. **Best-effort here** — the loop runs as a Claude Code Remote session with no production egress and no `gh` CLI, so both collectors skip; `.github/workflows/metrics-collectors.yml` is the scheduled home that actually produces data (#5528), and `metricsFreshness` (#5529) reports it when they stop |
