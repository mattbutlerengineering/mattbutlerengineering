...
<!-- For checkpoint task examples and patterns, see @${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/references/checkpoints.md -->
...
See `${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
