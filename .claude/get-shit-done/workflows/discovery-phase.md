...
See ${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/discovery.md:
   - Define clear scope
...
6. **Create comprehensive DISCOVERY.md:**
   - Full structure from ${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/discovery.md
...
Use ${PROJECT_ROOT:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/discovery.md.
