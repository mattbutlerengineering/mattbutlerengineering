...
- **Global scope**: `/Users/mbutler/github/mattbutlerengineering/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mbutler/github/mattbutlerengineering/.claude/notes/`)
...
2. Glob `/Users/mbutler/github/mattbutlerengineering/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mbutler/github/mattbutlerengineering/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mbutler/github/mattbutlerengineering/.claude/notes/` — works in any directory
