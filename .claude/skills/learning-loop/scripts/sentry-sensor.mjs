...
async function getSentryMetrics() {
  try {
    const response = await fetch('https://sentry.io/api/0/organizations/mattbutlerengineering/issues/?statsPeriod=7d&limit=50', {
    ...
    const result = {
      timestamp: new Date().toISOString(), period: '7d',
      metrics: {
